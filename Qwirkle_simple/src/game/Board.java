...
public class Board extends GridPane {
    ...
    public Board() {
        ...
        NUM_COLUMNS =  (int) (primaryScreenBounds.getWidth() / (Tile.TILE_SIZE + GAP) - 1);
        NUM_ROWS =  (int) (primaryScreenBounds.getHeight() / (Tile.TILE_SIZE + GAP) - 3);
        ...
        for (int row = 0; row < NUM_ROWS; row++) {
            for (int col = 0; col < NUM_COLUMNS; col++) {
                PlaceHolder tileHolder = new PlaceHolder(row, col);
